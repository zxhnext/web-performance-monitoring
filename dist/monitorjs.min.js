    ...
    (0, _createClass3.default)(API, [{
        ...
        value: function sendInfo(data) {
            try {
                ...
                navigator.sendBeacon(this.url, (0, _stringify2.default)(data));
            } catch (error) {
                console.log(error);
            }
        }
...
exports.ObserverJs = exports.MonitorJS = undefined;

var _monitorjs = __webpack_require__(62);

var _monitorjs2 = _interopRequireDefault(_monitorjs);

var _observer = __webpack_require__(121);
...
exports.ObserverJs = _observer2.default;


window.MonitorJS = _monitorjs2.default;
window.ObserverJs = _observer2.default;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(28)(Function.call, __webpack_require__(53).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _performance = __webpack_require__(59);
...
var MonitorPerformance = function () {
    ...
    (0, _createClass3.default)(MonitorPerformance, [{
        ...
        value: function record(params) {
            ...
            _performance2.default.onLoad(function () {
                if (_this.isPage) {
...
var _ttiPolyfill = __webpack_require__(125);
...
// FP FCP
var observer1 = new PerformanceObserver(function (list) {
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = undefined;

    try {
        for (var _iterator = (0, _getIterator3.default)(list.getEntries()), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
var observer2 = new PerformanceObserver(function (list) {
    var _iteratorNormalCompletion2 = true;
    var _didIteratorError2 = false;
    var _iteratorError2 = undefined;

    try {
        for (var _iterator2 = (0, _getIterator3.default)(list.getEntries()), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
exports.default = {
    getTimesAndReport: function getTimesAndReport(params) {
        _ttiPolyfill2.default.getFirstConsistentlyInteractive().then(function (tti) {
            ...
            try {
                for (var _iterator3 = (0, _getIterator3.default)(perfEntries), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            ...
            (0, _assign2.default)(times, { pageId: params ? params.pageId : "", tti: tti });
            console.log('observer', times);
            new _api2.default(params.url).report(times);
        });
    },
...
"undefined"!=typeof module&&module.exports?module.exports=H: true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function(){return H}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)):window.ttiPolyfill=H;})();
